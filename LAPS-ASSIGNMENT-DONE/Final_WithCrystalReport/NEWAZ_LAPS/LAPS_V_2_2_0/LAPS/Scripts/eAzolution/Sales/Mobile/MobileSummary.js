...
var MobileSummaryHelper = {
    ...
    GenerateMobileColumns: function () {
        return columns = [
           ...
           // { field: "BrandId", title: "Brand", width: 100 },
            ...
            { field: "BrandId", title: "BrandId", hidden:true, width: 100 },

            { field: "Color", title: "Color", width: 100 },
            { field: "ColorId", title: "ColorId", hidden: true, width: 100 },
    ...
    PrintMobileInfo: function () {
        debugger;
        var jsonParam = "";
        var url = "../Mobile/GetMobileInfoReport/";
